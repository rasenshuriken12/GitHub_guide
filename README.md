...
• Create a New Repository: 
	• Navigate to your GitHub dashboard and click the "New" button to create a new repository. [2]  
...
• Configure GitHub Pages: 
	• Navigate to your repository on GitHub and click on the Settings tab. [3]  
